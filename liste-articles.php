...
<body>
    <div class="container">
        ...
        <?php
        function accrocheArticle(array $article = null) {   // On type en array et on met la valeur null par défaut
            // On prévoit le cas où il n'y a pas de contenu (ou pas d'article !)
            if (empty($article['contenu'])) return 'Accroche indisponible...';

            // On renvoie les 200 premiers caractères du contenu
        ...
        <div class="list-group my-4">
            ...
            foreach ($articles as $article) { ?>
                ...
                <article class="list-group-item list-group-item-action" aria-current="true">
                    ...
                    <!-- On utilise la fonction accrocheArticle ici -->
